export default async function decorate(block) {
  ...
  block.innerHTML = '<div class="banner-content" data-aue-type="reference" data-aue-filter="cf"><div data-aue-prop="heroImage" data-aue-type="media" class="banner-detail" style="background-image: linear-gradient(90deg,rgba(0,0,0,0.6), rgba(0,0,0,0.1) 80%);"><p data-aue-prop="title" data-aue-type="text" class="headline">'+ cfReq.title + '</p>'+
      ...
      '<p data-aue-prop="preTitle" data-aue-type="text" class="pretitle">'+cfReq.preTitle+'</p><p data-aue-prop="detail" data-aue-type="richtext" class="detail">'+cfReq.description+'</p><p class="button-container"><a data-aue-prop="ctaUrl" data-aue-type="text" href="'+cfReq.ctaRedirectLink+'" title="'+cfReq.ctaButtonText+'" class="button">'+cfReq.ctaButtonText+'</a></p></div></div>';
}
